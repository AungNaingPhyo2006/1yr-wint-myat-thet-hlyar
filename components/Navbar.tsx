      ...
      <header className="border-b py-2">
        <div className="flex justify-between items-center">
          <div className="logo relative">
            <h2 className="font-bold font-2xl before:z-[-1] before:h-4 before:block before:absolute before:w-full before:bottom-1 before:-skew-y-3 ">
              <Link href="/" className="">
                Aung Naing Phyo
              </Link>
            </h2>
                ...
                links.map(link => {
                  return (
                    <li className="relative" key={link.id}>
                      <Link href={link.link_url} className={`${link.link_url === pathname && 'before:h-4 before:block before:absolute before:w-full before:bottom-1 before:-skew-y-3 before:bg-[var(--secondary-tint-70)]'} uppercase font-2xl before:z-[-1]`}>
                        {link.title} 
                      </Link>
                    </li>
                  )
